...
alls$ticket_room_number1 <- alls$ticket_room_number %% 10
alls$ticket_room_number2 <- floor(alls$ticket_room_number/10) %% 10
alls$ticket_room_number3 <- floor(alls$ticket_room_number/100) %% 10
alls$ticket_room_number4 <- floor(alls$ticket_room_number/1000) %% 10
alls$ticket_room_number5 <- floor(alls$ticket_room_number/10000) %% 10
...
alls$Sex <- factor(alls$Sex)
alls$new_Embarked <- factor(alls$new_Embarked)
alls$ticket_room_number1 <- factor(alls$ticket_room_number1)
alls$ticket_room_number2 <- factor(alls$ticket_room_number2)
alls$ticket_room_number3 <- factor(alls$ticket_room_number3)
alls$ticket_room_number4 <- factor(alls$ticket_room_number4)
alls$ticket_room_number5 <- factor(alls$ticket_room_number5)
...
cT_train <- titanic_train[c(-1,-2,-5,-9,-10,-14:-16)] 
cT_test <- titanic_test[c(-1,-2,-5,-9,-10,-14:-16)]
...
#NA to 0
c_train$ticket_room_number1[is.na(c_train$ticket_room_number1)]=0
c_train$ticket_room_number2[is.na(c_train$ticket_room_number2)] = 0
c_train$ticket_room_number3[is.na(c_train$ticket_room_number3)] = 0
c_train$ticket_room_number4[is.na(c_train$ticket_room_number4)] = 0
c_train$ticket_room_number5[is.na(c_train$ticket_room_number5)] = 0
...
write.csv(prediction,file="prediction27.csv")
